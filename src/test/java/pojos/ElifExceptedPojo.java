...
public class ElifExceptedPojo {
    ...
    public ElifExceptedPojo() {
    }


    public ElifExceptedPojo(String day, int educationTermId, ArrayList<Integer> lessonIdList, String startTime, String stopTime) {
        this.day = day;
